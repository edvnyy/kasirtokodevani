...
@section('content')
    ...
    <div class="card card-cyan card-outline">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    ...
                    <p>Nama Pelanggan: {{ $pelanggan ? $pelanggan->nama : '-' }}</p>
                    <p>No. Telepon:  {{ $pelanggan ? $pelanggan->nomor_tlp : '-' }}</p>
        ...
        <div class="card-footer form-inline">
            ...
            @endif
            <a href="{{ route('transaksi.cetak', ['transaksi' => $penjualan->id]) }}" target="_blank"

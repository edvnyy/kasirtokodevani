...
@section('content')
    ...
    <div class="card card-cyan card-outline">
        <div class="card-header form-inline">
            <a href="{{ route('produk.create') }}" class="btn btn-outline-primary">
        ...
        <div class="card-body p-8">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7">Tidak ada data produk yang sesuai dengan pencarian Anda.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('produk.destroy', ['produk' => $produk->id]) }}" method="post"
                            style="display: none;" id="formBatal{{ $produk->id }}">
                            @csrf
                            @method('DELETE')
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger"
                            onclick="event.preventDefault(); document.getElementById('formBatal{{ $produk->id }}').submit();">
                            Ya, Hapus!
                        </button>
                    </div>
                </div>

...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            <form method="POST" action="{{ route('produk.store') }}" class="card card-cyan card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <x-input name="kode_produk" type="text" :value="$kodeProduk" readonly />
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer form-inline">
                    <button type="submit" class="btn btn-outline-primary">Simpan Produk</button>

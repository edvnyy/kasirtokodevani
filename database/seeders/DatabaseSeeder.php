...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\User::create([
            ...
            'username' => 'petugas',
            'role'=>'petugas',
            'email'=>'devaniamelia@gmail.com',
            'password'=>bcrypt('password'),
        ]);
        \App\Models\Pelanggan::create([
            'nama' => 'Devani Amelia',
            'alamat' => 'Purwadadi',
            'nomor_tlp'=>'083826272207',
        ]);
        \App\Models\Pelanggan::create([
            'nama' => 'Liza Indah',
            'alamat' => 'Purwadadi',
            'nomor_tlp'=>'083879071434',
        ]);
        ...
        \App\Models\Stok::create([
            'produk_id' => 1,
            'nama_suplier'=>'Toko Haji Pawit',
            'jumlah'=>'250',
            'tanggal'=>date('Y-m-d', strtotime('-1 week'))
        ]);
        \App\Models\Stok::create([
            'produk_id' => 2,
            'nama_suplier'=>'Agen BRI-Link',
            'jumlah'=>'100',
            'tanggal'=>date('Y-m-d', strtotime('-1 week'))
        ]);
        ...
        \App\Models\Penjualan::create([
            'user_id' => 1,
            'pelanggan_id' => 1,
            'nomor_transaksi'=> date('Y-m-d') . '0001',
        ...
        \App\Models\Penjualan::create([
            'user_id' => 2,
            'pelanggan_id' => 2,
            'nomor_transaksi'=> date('Y-m-d') . '0002',
            'tanggal'=>date('Y-m-d H:i:s'),
           'subtotal'=> 13500,
           'pajak'=> 1350,
           'total'=>14850,
